...
const TPL = 'tplMetroValueBoolCheckbox';

/** `tplMetroValueBoolCheckbox` - a checkbox for a boolean state, with free html before and after it */
export default class MetroValueBoolCheckbox extends TileWidget<Record<string, any>> {
    ...
    getWidgetInfo(): RxWidgetInfo {
        return MetroValueBoolCheckbox.getWidgetInfo();
    }
